    ...
    <div className="flex flex-col md:flex-row">
      <div className="flex justify-center items-center w-full">
        ...
        <div className="flex flex-col w-full items-center">
          ...
          <TokenDetails title="Name" value="SAWON(ETH)" />
          <TokenDetails title="Symbol" value="SAWON" />
          <TokenDetails title="Decimals" value="18" />

          <TokenDetails title="Total Supply" value={millify(21004)} />
          <TokenDetails title="Maximum Supply" value={millify(0)} />
          <TokenDetails
            title="Token Address"
            value="0x52D1eC2ed762D7Fb3bE336Ec678569C730B87d66"
          />
        </div>
      </div>
